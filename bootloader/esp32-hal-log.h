...
#define log_v_simp(format, ...) log_printf(ARDUHAL_SHORT_LOG_FORMAT(V, format), ##__VA_ARGS__)
...
#define log_v_simp(format, ...) do {ESP_LOG_LEVEL_LOCAL(ESP_LOG_VERBOSE, TAG, format, ##__VA_ARGS__);}while(0)
...
#define log_v_simp(format, ...)  do {} while(0)
...
#define log_d_simp(format, ...) log_printf(ARDUHAL_SHORT_LOG_FORMAT(D, format), ##__VA_ARGS__)
...
#define log_d_simp(format, ...) do {ESP_LOG_LEVEL_LOCAL(ESP_LOG_DEBUG, TAG, format, ##__VA_ARGS__);}while(0)
...
#define log_d_simp(format, ...)  do {} while(0)
...
#define log_i_simp(format, ...) log_printf(ARDUHAL_SHORT_LOG_FORMAT(I, format), ##__VA_ARGS__)
...
#define log_i_simp(format, ...) do {ESP_LOG_LEVEL_LOCAL(ESP_LOG_INFO, TAG, format, ##__VA_ARGS__);}while(0)
...
#define log_i_simp(format, ...) do {} while(0)
...
#define log_w_simp(format, ...) log_printf(ARDUHAL_SHORT_LOG_FORMAT(W, format), ##__VA_ARGS__)
...
#define log_w_simp(format, ...) do {ESP_LOG_LEVEL_LOCAL(ESP_LOG_WARN, TAG, format, ##__VA_ARGS__);}while(0)
...
#define log_w_simp(format, ...) do {} while(0)
...
#define log_e_simp(format, ...) log_printf(ARDUHAL_SHORT_LOG_FORMAT(E, format), ##__VA_ARGS__)
...
#define log_e_simp(format, ...) do {log_to_esp(TAG, ESP_LOG_ERROR, format, ##__VA_ARGS__);}while(0)
...
#define log_e_simp(format, ...) do {} while(0)
...
#define log_n_simp(format, ...) log_printf(ARDUHAL_SHORT_LOG_FORMAT(E, format), ##__VA_ARGS__)
...
#define log_n_simp(format, ...) do {ESP_LOG_LEVEL_LOCAL(ESP_LOG_ERROR, TAG, format, ##__VA_ARGS__);}while(0)
...
#define log_n_simp(format, ...) do {} while(0)
